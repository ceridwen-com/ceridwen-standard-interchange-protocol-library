 ...
 * Static Fields		
 */
	    fields.put("alert", new FieldDescriptor(null, Boolean.class, 1, false));
		fields.put("available", new FieldDescriptor(null, Boolean.class, 1, false));
		...
		fields.put("feeAmount", new FieldDescriptor("BV", String.class, null, true));
		fields.put("feeLimit", new FieldDescriptor("CC", String.class, null, true));
		...
		fields.put("itemIdentifier", new FieldDescriptor("AB", String.class, null, true));
		fields.put("itemProperties", new FieldDescriptor("CH", String.class, null, false));
		fields.put("language", new FieldDescriptor(null, Language.class, 3, false));
		fields.put("libraryName", new FieldDescriptor("AM", String.class, null, true));
		...
		fields.put("offlineOk", new FieldDescriptor(null, Boolean.class, 1, false));
		...
		fields.put("paymentAccepted", new FieldDescriptor(null, Boolean.class, 1, false));
		fields.put("paymentType", new FieldDescriptor(null, PaymentType.class, 2, false));
		fields.put("permanentLocation", new FieldDescriptor("AQ", String.class, null, true));
        fields.put("personalName", new FieldDescriptor("AE", String.class, null, true));
		fields.put("pickupLocation", new FieldDescriptor("BS", String.class, null, true));	
