...
public abstract class AbstractSocketConnection extends Connection {
    private static Log log = LogFactory.getLog(AbstractSocketConnection.class);

    private Socket socket;
    private BufferedReader in;
    private BufferedWriter out;

    abstract Socket getSocket() throws Exception;
        ...
        try {
            ...
            if (retryAttempts > 0) {
                try {
                    ...
                    AbstractSocketConnection.log.debug("Thread sleep error", ex1);
                }
